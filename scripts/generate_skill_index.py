...
CATEGORIES = [
    ('Meta and orchestration', ['orchestrator', 'context', 'knowledge', 'project-delivery', 'brainstorming', 'skill-authoring', 'skill-quality']),
    ...
    ('Frontend, design, accessibility, and media', ['frontend', 'react', 'typescript', 'javascript-node', 'ui-ux', 'responsive', 'accessibility', 'browser-testing', 'visual', 'motion', 'threejs', 'media', 'watermark']),
    ...
    ('DevOps, cloud, reliability, and automation', ['docker', 'infrastructure', 'ci-cd', 'observability', 'performance', 'automation', 'systems-design']),
    ('Research, science, and evidence', ['research', 'scientific', 'physics', 'chemistry', 'biology', 'earth', 'experimental', 'units', 'visualization-plotting']),
