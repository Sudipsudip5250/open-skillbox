...
Use this skill when the request matches **Plan safe feature-flag rollout, cohort exposure, observability, kill switches, rollback, lifecycle ownership, and cleanup. Use for product and service releases.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.
...
For a request involving **feature-flag-rollout-strategy**, use this compact record:
