...
Use this skill when the request matches **Design reliable batch or streaming pipelines for ingestion, validation, transformation, storage, orchestration, and lineage. Use for data-platform architecture and implementation planning.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.
...
For a request involving **data-engineering-pipelines**, use this compact record:
