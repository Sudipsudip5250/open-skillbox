---
name: user-embedded-iot-systems
description: Design and reason about constrained devices, sensors, firmware, communication, power, reliability, and secure update flows. Use for educational or authorized embedded systems work.
---
...
Use this skill when the request matches **Design and reason about constrained devices, sensors, firmware, communication, power, reliability, and secure update flows. Use for educational or authorized embedded systems work.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Design and reason about constrained devices, sensors, firmware, communication, power, reliability, and secure update flows. Use for educational or authorized embedded systems work. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define hardware, timing, power, sensor, actuator, connectivity, safety, and threat constraints; partition hardware and firmware responsibilities; choose a state machine or data-flow model; specify failure modes; and plan testable interfaces.
...
For a request involving **embedded-iot-systems**, use this compact record:
...
Check timing budgets, units, power or battery estimates, sensor calibration, offline behavior, watchdog and recovery paths, update authenticity, and safe fail states. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
