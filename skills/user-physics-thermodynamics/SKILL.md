---
name: user-physics-thermodynamics
description: Analyze temperature, heat, work, idealized processes, energy balances, entropy concepts, and simple thermal systems. Use for educational thermodynamics problems.
---
...
Use this skill when the request matches **Analyze temperature, heat, work, idealized processes, energy balances, entropy concepts, and simple thermal systems. Use for educational thermodynamics problems.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze temperature, heat, work, idealized processes, energy balances, entropy concepts, and simple thermal systems. Use for educational thermodynamics problems. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define system, surroundings, state variables, process path, sign convention, and idealization; choose an equation of state or first-law balance; distinguish heat from temperature; and state the process assumptions.
...
For a request involving **physics-thermodynamics**, use this compact record:
...
Check units and signs, state-function versus path-dependent quantities, limiting behavior, energy conservation, feasible temperatures, and whether the second-law direction is respected. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
