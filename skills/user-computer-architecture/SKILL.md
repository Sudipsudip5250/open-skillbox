---
name: user-computer-architecture
description: Explain and analyze instruction execution, data paths, memory hierarchy, caching, pipelining, parallelism, performance, and representation. Use for architecture fundamentals.
---
...
Use this skill when the request matches **Explain and analyze instruction execution, data paths, memory hierarchy, caching, pipelining, parallelism, performance, and representation. Use for architecture fundamentals.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Explain and analyze instruction execution, data paths, memory hierarchy, caching, pipelining, parallelism, performance, and representation. Use for architecture fundamentals. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define workload, instruction set, latency, throughput, memory level, and bottleneck; trace the data path; select an AMAT, speedup, pipeline, or representation model; state hardware assumptions; and separate architecture from implementation detail.
...
For a request involving **computer-architecture**, use this compact record:
...
Check units and denominators, dependency and hazard assumptions, cache-hit accounting, Amdahl-style limits, address widths, and whether the performance claim is workload-specific. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
