---
name: user-operating-systems-concepts
description: Explain processes, threads, scheduling, virtual memory, filesystems, synchronization, isolation, and system calls. Use for OS fundamentals and debugging concepts.
---
...
Use this skill when the request matches **Explain processes, threads, scheduling, virtual memory, filesystems, synchronization, isolation, and system calls. Use for OS fundamentals and debugging concepts.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Explain processes, threads, scheduling, virtual memory, filesystems, synchronization, isolation, and system calls. Use for OS fundamentals and debugging concepts. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Identify resources, actors, state transitions, and concurrency boundaries; model process or memory behavior; choose scheduling, locking, paging, or filesystem reasoning; and distinguish conceptual examples from host-specific commands.
...
For a request involving **operating-systems-concepts**, use this compact record:
...
Check invariants, race possibilities, deadlock conditions, memory address translation, resource ownership, failure recovery, and least-privilege assumptions. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
