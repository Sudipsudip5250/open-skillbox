---
name: user-networking-fundamentals
description: Analyze layered networks, addressing, routing, transport behavior, DNS, HTTP, reliability, and network troubleshooting. Use for educational or authorized engineering work.
---
...
Use this skill when the request matches **Analyze layered networks, addressing, routing, transport behavior, DNS, HTTP, reliability, and network troubleshooting. Use for educational or authorized engineering work.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze layered networks, addressing, routing, transport behavior, DNS, HTTP, reliability, and network troubleshooting. Use for educational or authorized engineering work. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define endpoints, layers, protocol version, topology, trust boundary, and symptom; trace a request or packet; select addressing, routing, transport, or application-level reasoning; collect observable evidence; and propose reversible tests.
...
For a request involving **networking-fundamentals**, use this compact record:
...
Check packet or log timestamps, address and port scope, MTU and latency assumptions, DNS and TLS boundaries, reproducibility, and authorization before touching systems. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
