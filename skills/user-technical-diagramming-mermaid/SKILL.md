---
name: user-technical-diagramming-mermaid
description: Create maintainable Mermaid flowcharts, sequence diagrams, state diagrams, class diagrams, entity relationships, timelines, and architecture views. Use for technical communication and documentation.
---

# Technical Diagramming with Mermaid

## Quick start

Use this skill when the request matches **Create maintainable Mermaid flowcharts, sequence diagrams, state diagrams, class diagrams, entity relationships, timelines, and architecture views. Use for technical communication and documentation.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Create maintainable Mermaid flowcharts, sequence diagrams, state diagrams, class diagrams, entity relationships, timelines, and architecture views. Use for technical communication and documentation. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Choose the diagram’s question and audience; select the smallest diagram type that answers it; name nodes and boundaries consistently; encode direction, ownership, trust, and failure paths; add a legend when needed; and keep source text beside the rendered artifact.
...
For a request involving **technical-diagramming-mermaid**, use this compact record:
...
Render the diagram, check syntax and readability, verify every edge against the described system, check accessibility and print scale, avoid secrets or private topology, and version the source with the document. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
