---
name: user-chemistry-stoichiometry
description: Balance reactions and calculate moles, masses, concentrations, limiting reactants, yields, and solution quantities. Use for educational quantitative chemistry.
---
...
Use this skill when the request matches **Balance reactions and calculate moles, masses, concentrations, limiting reactants, yields, and solution quantities. Use for educational quantitative chemistry.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Balance reactions and calculate moles, masses, concentrations, limiting reactants, yields, and solution quantities. Use for educational quantitative chemistry. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Write and balance the chemical equation; convert every given to moles; identify limiting and excess reactants; apply mole ratios; convert to the requested unit; and state purity, yield, solution, or gas assumptions.
...
For a request involving **chemistry-stoichiometry**, use this compact record:
...
Recheck atom and charge balance, significant figures, limiting-reactant logic, units, mass conservation, concentration definitions, and whether the result is physically plausible. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
