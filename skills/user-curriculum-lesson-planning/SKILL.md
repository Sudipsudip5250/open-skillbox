---
name: user-curriculum-lesson-planning
description: Create coherent lessons, units, objectives, activities, assessments, scaffolds, and extensions. Use for formal or informal teaching plans.
---
...
Use this skill when the request matches **Create coherent lessons, units, objectives, activities, assessments, scaffolds, and extensions. Use for formal or informal teaching plans.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Create coherent lessons, units, objectives, activities, assessments, scaffolds, and extensions. Use for formal or informal teaching plans. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define learners, prerequisites, standards or goals, time, resources, accessibility needs, and evidence of learning; write measurable objectives; sequence activate-model-practice-apply-reflect; and align instruction with assessment.
...
For a request involving **curriculum-lesson-planning**, use this compact record:
