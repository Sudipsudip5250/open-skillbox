---
name: user-earth-environmental-systems
description: Reason about Earth materials, cycles, climate, ecosystems, hazards, resources, and human-environment interactions. Use for educational earth and environmental science.
---
...
Use this skill when the request matches **Reason about Earth materials, cycles, climate, ecosystems, hazards, resources, and human-environment interactions. Use for educational earth and environmental science.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Reason about Earth materials, cycles, climate, ecosystems, hazards, resources, and human-environment interactions. Use for educational earth and environmental science. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define system boundary, reservoirs, fluxes, time scale, spatial scale, and feedbacks; construct a stock-flow or causal model; distinguish observation, model output, and scenario; and identify uncertainty drivers.
...
For a request involving **earth-environmental-systems**, use this compact record:
...
Check conservation and units, timescale compatibility, baseline selection, feedback direction, scale mismatch, uncertainty ranges, and whether evidence supports causal language. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
