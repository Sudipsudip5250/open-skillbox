---
name: user-physics-electricity-magnetism
description: Analyze introductory charge, electric fields, circuits, magnetic fields, induction, and electromagnetic quantities. Use for educational E&M reasoning.
---
...
Use this skill when the request matches **Analyze introductory charge, electric fields, circuits, magnetic fields, induction, and electromagnetic quantities. Use for educational E&M reasoning.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze introductory charge, electric fields, circuits, magnetic fields, induction, and electromagnetic quantities. Use for educational E&M reasoning. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define sources, geometry, reference direction, and material assumptions; choose Coulomb or field methods, potential, Kirchhoff laws, circuit equivalents, Lorentz force, or induction; separate scalar and vector quantities; and state idealizations.
...
For a request involving **physics-electricity-magnetism**, use this compact record:
...
Check dimensions, polarity and direction, Kirchhoff current and voltage balance, limiting resistance or distance cases, and energy or power consistency. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
