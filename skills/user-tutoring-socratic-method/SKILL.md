---
name: user-tutoring-socratic-method
description: Guide learners through questions, hints, retrieval, explanations, and feedback without hiding the reasoning. Use for tutoring across math, science, programming, and academic concepts.
---
...
Use this skill when the request matches **Guide learners through questions, hints, retrieval, explanations, and feedback without hiding the reasoning. Use for tutoring across math, science, programming, and academic concepts.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Guide learners through questions, hints, retrieval, explanations, and feedback without hiding the reasoning. Use for tutoring across math, science, programming, and academic concepts. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Diagnose the learner’s goal and current step; ask one purposeful question at a time; offer graduated hints; invite the learner to predict or explain; correct misconceptions precisely; then consolidate with a worked example and a transfer problem.
...
For a request involving **tutoring-socratic-method**, use this compact record:
...
Check learner understanding by asking for justification or a new example, not merely agreement; distinguish arithmetic mistakes from conceptual gaps; and adapt difficulty and pacing. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
