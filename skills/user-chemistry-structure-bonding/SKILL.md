---
name: user-chemistry-structure-bonding
description: Reason about atomic structure, periodic trends, Lewis structures, formal charge, resonance, geometry, polarity, intermolecular forces, and bonding models. Use for conceptual chemistry.
---
...
Use this skill when the request matches **Reason about atomic structure, periodic trends, Lewis structures, formal charge, resonance, geometry, polarity, intermolecular forces, and bonding models. Use for conceptual chemistry.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Reason about atomic structure, periodic trends, Lewis structures, formal charge, resonance, geometry, polarity, intermolecular forces, and bonding models. Use for conceptual chemistry. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Identify species and charge; count valence electrons; choose ionic, covalent, metallic, Lewis, VSEPR, orbital, or intermolecular-force models; distinguish model predictions from measured properties; and draw structures clearly.
...
For a request involving **chemistry-structure-bonding**, use this compact record:
...
Count electrons and formal charges, verify octets or justified exceptions, check geometry against electron domains, inspect symmetry and polarity, and state model limitations. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
