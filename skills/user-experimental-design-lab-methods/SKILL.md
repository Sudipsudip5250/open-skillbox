---
name: user-experimental-design-lab-methods
description: Plan safe, reproducible educational or research experiments, observations, controls, measurements, and analysis. Use for experimental design, not for hazardous procedural instructions.
---

# Experimental Design and Lab Methods

## Quick start

Use this skill when the request matches **Plan safe, reproducible educational or research experiments, observations, controls, measurements, and analysis. Use for experimental design, not for hazardous procedural instructions.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Plan safe, reproducible educational or research experiments, observations, controls, measurements, and analysis. Use for experimental design, not for hazardous procedural instructions. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. State the research question and hypothesis; define variables, operational measures, controls, randomization or blocking, sample size rationale, protocol at a safe level, data schema, and stopping or exclusion rules; then predefine analysis.
...
For a request involving **experimental-design-lab-methods**, use this compact record:
...
Check validity, repeatability, calibration, units, blinding or bias controls, missing-data handling, uncertainty, ethical approval, and whether the design can answer the question. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
