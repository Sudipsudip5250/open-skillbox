---
name: user-biology-genetics-evolution
description: Analyze inheritance, variation, population change, natural selection, phylogenetic reasoning, and genetic evidence. Use for educational genetics and evolution.
---
...
Use this skill when the request matches **Analyze inheritance, variation, population change, natural selection, phylogenetic reasoning, and genetic evidence. Use for educational genetics and evolution.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze inheritance, variation, population change, natural selection, phylogenetic reasoning, and genetic evidence. Use for educational genetics and evolution. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define alleles, traits, population, generation, and sampling unit; choose Punnett, probability, population-genetic, pedigree, or phylogenetic reasoning; separate genotype from phenotype; and specify assumptions.
...
For a request involving **biology-genetics-evolution**, use this compact record:
...
Check probabilities and totals, allele-frequency normalization, sample-size limits, tree interpretation, confounding, and whether a pattern supports association, selection, or only a compatible explanation. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
