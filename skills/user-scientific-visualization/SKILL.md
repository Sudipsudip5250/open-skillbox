---
name: user-scientific-visualization
description: Design accurate plots, diagrams, maps, uncertainty displays, and explanatory scientific figures. Use for communicating measured, modeled, or simulated data.
---
...
1. Identify audience, claim, variables, units, uncertainty, and scale; choose an encoding that matches the data; preserve provenance and transformations; annotate assumptions; and write a caption that states what the figure does and does not show.
