---
name: user-electronics-circuit-concepts
description: Analyze basic voltage, current, resistance, capacitors, inductors, diodes, transistors, measurement, and signal-conditioning concepts. Use for educational circuit reasoning.
---
...
Use this skill when the request matches **Analyze basic voltage, current, resistance, capacitors, inductors, diodes, transistors, measurement, and signal-conditioning concepts. Use for educational circuit reasoning.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze basic voltage, current, resistance, capacitors, inductors, diodes, transistors, measurement, and signal-conditioning concepts. Use for educational circuit reasoning. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Draw the circuit with references and component values; identify series, parallel, source, load, and ground conventions; choose Ohm, Kirchhoff, equivalent-circuit, transient, or small-signal reasoning; and state idealizations.
...
For a request involving **electronics-circuit-concepts**, use this compact record:
...
Check dimensions, node and loop balances, polarity, power dissipation, initial and final conditions, component ratings, and whether the ideal model is safe to apply. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
