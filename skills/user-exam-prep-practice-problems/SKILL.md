---
name: user-exam-prep-practice-problems
description: Create ethical study plans, diagnostic practice, worked solutions, feedback, and spaced review for exams. Use for learning and preparation, not answer-only test circumvention.
---
...
Use this skill when the request matches **Create ethical study plans, diagnostic practice, worked solutions, feedback, and spaced review for exams. Use for learning and preparation, not answer-only test circumvention.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Create ethical study plans, diagnostic practice, worked solutions, feedback, and spaced review for exams. Use for learning and preparation, not answer-only test circumvention. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Identify syllabus, exam format, time horizon, current mastery, and constraints; build a diagnostic set; classify errors; schedule retrieval and mixed practice; provide full reasoning; and simulate conditions without using restricted live exam content.
...
For a request involving **exam-prep-practice-problems**, use this compact record:
