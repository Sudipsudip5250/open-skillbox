---
name: user-biology-cell-molecular
description: Explain cell structure, membranes, transport, metabolism, gene expression, signaling, and molecular mechanisms. Use for educational cell and molecular biology.
---

# Biology Cell and Molecular Processes

## Quick start

Use this skill when the request matches **Explain cell structure, membranes, transport, metabolism, gene expression, signaling, and molecular mechanisms. Use for educational cell and molecular biology.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Explain cell structure, membranes, transport, metabolism, gene expression, signaling, and molecular mechanisms. Use for educational cell and molecular biology. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Define the biological level and process; identify structures, inputs, outputs, compartments, and energy or information flows; map a causal sequence; distinguish mechanism from correlation; and cite the relevant evidence type.
...
For a request involving **biology-cell-molecular**, use this compact record:
...
Check conservation of matter or information where applicable, compartment and direction logic, terminology, control conditions, and whether the claim is organism- or context-specific. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
