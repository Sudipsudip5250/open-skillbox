---
name: user-physics-mechanics
description: Analyze motion, forces, energy, momentum, rotation, and simple mechanical systems. Use for educational physics problems and quantitative mechanics models.
---
...
Use this skill when the request matches **Analyze motion, forces, energy, momentum, rotation, and simple mechanical systems. Use for educational physics problems and quantitative mechanics models.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze motion, forces, energy, momentum, rotation, and simple mechanical systems. Use for educational physics problems and quantitative mechanics models. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Identify the system, frame, knowns, unknowns, constraints, and sign convention; draw a free-body or state diagram; select kinematics, Newton laws, energy, momentum, or torque; solve symbolically before substituting values; and interpret the result.
...
For a request involving **physics-mechanics**, use this compact record:
...
Check units, limiting cases, conservation laws, direction signs, feasible speeds or forces, and agreement between an alternate law and the primary solution. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
