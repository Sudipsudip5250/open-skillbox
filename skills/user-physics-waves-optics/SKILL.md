---
name: user-physics-waves-optics
description: Analyze oscillations, wave parameters, superposition, sound, geometric optics, and introductory interference or diffraction. Use for educational wave and optics problems.
---
...
Use this skill when the request matches **Analyze oscillations, wave parameters, superposition, sound, geometric optics, and introductory interference or diffraction. Use for educational wave and optics problems.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Analyze oscillations, wave parameters, superposition, sound, geometric optics, and introductory interference or diffraction. Use for educational wave and optics problems. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Classify the wave or optical system; define frequency, wavelength, phase, medium, and geometry; choose a kinematic, interference, ray, lens, or superposition model; track sign and angle conventions; and report observable consequences.
...
For a request involving **physics-waves-optics**, use this compact record:
...
Check dimensional relations such as speed, frequency, and wavelength; boundary conditions; image orientation and scale; phase limits; and whether the approximation matches the wavelength and geometry. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
