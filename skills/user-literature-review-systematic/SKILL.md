---
name: user-literature-review-systematic
description: Plan and execute transparent systematic or scoping reviews with searchable questions, screening, extraction, synthesis, and reproducible records. Use for research-depth evidence reviews.
---
...
Use this skill when the request matches **Plan and execute transparent systematic or scoping reviews with searchable questions, screening, extraction, synthesis, and reproducible records. Use for research-depth evidence reviews.** Start with the smallest defensible input set, state what is known and unknown, then follow the method-selection workflow. Produce an intermediate record before the final answer so another agent can review or continue the work.


## Scope and classification

Plan and execute transparent systematic or scoping reviews with searchable questions, screening, extraction, synthesis, and reproducible records. Use for research-depth evidence reviews. Begin by identifying the system, objects, evidence, constraints, and expected level of precision.

## Method-selection workflow

1. Frame the question and eligibility criteria; select databases and search strings; record dates and versions; deduplicate and screen; extract study, design, population, outcome, and bias fields; synthesize appropriately; and report exclusions and limitations.
...
For a request involving **literature-review-systematic**, use this compact record:
...
Check protocol consistency, search completeness, duplicate handling, inter-reviewer agreement or audit trail, risk-of-bias fit, heterogeneity, publication bias, and that claims match the included evidence. Also perform an independent spot check, counterexample, replay, rendering, or alternate calculation whenever practical.
